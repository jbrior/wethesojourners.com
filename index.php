...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Tektur:wght@800&display=swap" rel="stylesheet">
...
<body>
    ...
    <div class="prayer-input-container">
        ...
        <p style="font-style:italic;font-size:15px;">**Your prayer request will be displayed below once approved.</p>
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST">
            ...
            <input type="submit" id="requestSubmitBtn" disabled>
        </form>
